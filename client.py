...
class ClientsGroup(object):
    ...
    def dataSetBalanceAllocation(self):
        UTKDataSet = GetDataSet(self.data_set_name, self.is_iid)

        test_data = torch.tensor(UTKDataSet.test_data)
        ...
        shards_id = np.random.permutation(UTKDataSet.train_data_size // shard_size)
...
if __name__=="__main__":
    MyClients = ClientsGroup('crop_part1', True, 100, 1)
